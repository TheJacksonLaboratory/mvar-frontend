...
const urlSampleStatsFile = environment.MMRDB_API_SAMPLE_STATS_URL + '/upload/';
...
export class UploadService {
    ...
    private setCall(fileType: string) {
        ...
        } else if (fileType === 'sampleStats') {
            this.url = urlSampleStatsFile;
            this.paramName = 'sampleStatsFile';
        }
